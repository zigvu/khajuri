...
ImgDir = 'C:\Users\\Amit\\Box Sync\\images\\blank'; # This is the directory containing input images
ImgDir = 'C:\Users\Amit\Documents\EvanVideo\SyncBox\Images\Blanks'
#ImgExt = ('*.bmp','*.png');   # Extension of the image files
ImgExt = ('*.bmp','*.png')
OutDir = 'C:\Users\Amit\Documents\EvanVideo\SyncBox\Results';
...
# Fetch a list of files with the specified extension
...
for ImgFile in ImgFiles:    
    try:
        # Read the file
        Img = skd.imread(ImgFile);
        # Run the blank detector
        IsBlank[k], IntensitySpan[k],ImgEntropy[k] = B.Is_Blank(Img)
